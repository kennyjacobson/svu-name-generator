...
function NameGen({closeFunction}) {
  ...
  function getFirstPart() {
    const height = lastName
    console.log(height)
    let firstPart = knightFirst[parseInt(height)]
    if(parseInt(height) < 56) {
      firstPart = "Hermes"
    }
    else if(parseInt(height) > 77) {
      firstPart = "Cronus"
    }
    return firstPart
  }
  ...
  function getNewName() {
    ...
    console.log(title)
    setKnightName(firstPart + " God of " + lastPart)
    setCurrentPage(2)
  }
          ...
          <Box textAlign="right" alignContent="end">
            ...
            {(currentPage === 1) ? (
              ...
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                Find out your Greek God name so you can properly defend and protect.
              </Typography>
              <Box
                component="form"
                sx={{
                ...
                <TextField value={lastName} onChange={e => setLastName(e.target.value)} id="first-name" label="Height in IN'" variant="outlined" />
                ...
                <Button onClick={getNewName} variant="outlined">Get Your Greek God Name</Button>
              </Box>
              </>  
            ) : (
              <>
                <Typography id="modal-modal-title" variant="h5" component="h2" sx={{marginTop:"1em"}}>
                  Your Greek God Name is...
                </Typography>
